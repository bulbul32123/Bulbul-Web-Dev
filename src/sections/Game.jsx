            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <motion.button
                  ...
                  className="bg-white text-black font-bold text-lg px-8 py-4 rounded-2xl flex items-center gap-3 hover:bg-gray-100 transition-all duration-300 group cursor-pointer"
                >
